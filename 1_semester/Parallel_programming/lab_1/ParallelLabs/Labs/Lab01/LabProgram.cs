...
// Реализовать пользовательский делегат и использовать его для вызова методов
//Метод, принимающий делегат Action<float>, целое число и значение float, возвращающий bool

namespace ParallelLabs.Labs.Lab01
{
    public delegate bool MyDelegate(Action<float> processor, int count, float value);

    public static class LabProgram
    {
